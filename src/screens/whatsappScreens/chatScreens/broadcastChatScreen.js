...
import BroadcastChatHeaderComponent from '../../../components/whatsappComponents/broadcastChatHeaderComponent';
class BroadcastChatScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      popupVisible: false,
      ...
      <View style={{flex: 1, backgroundColor: '#F6F6F6'}}>
        <React.Fragment>
          ...
          <ImageBackground
            ...
            <ScrollView>
              <ChatLeftComponent showUserImage showGroupChatContext />

              <View style={[styles.flexStyle, {height: 40}]}>
              ...
              <View style={{flex: 7, justifyContent: 'center'}}>
                <View style={styles.recordingViewStyle}>
                  <View style={{flex: 1, flexDirection: 'row'}}>
                    <View style={{width: 10}} />
                    <View
                      style={[styles.flexStyle, {alignItems: 'flex-start'}]}>
                      <Stopwatch
                        laps
